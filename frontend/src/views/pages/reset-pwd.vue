<template>
    <div class="login-bg">
        <div class="login-container">
            ...
            <p class="reset-text">enter your email</p>
            <el-form :model="param" :rules="rules" ref="register" size="large">
                ...
                >
                <p class="login-text"><el-link type="primary" @click="$router.push('/login')">back to login</el-link></p>
            </el-form>
        </div>
    </div>
</template>
...
const rules: FormRules = {
    email: [
        { required: true, message: 'enter email', trigger: 'blur' },
        {
            ...
            message: 'please enter the email with coorect format',
            trigger: 'blur',
        },
    ],
};
